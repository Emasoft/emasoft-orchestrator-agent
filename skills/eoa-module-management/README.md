...
Dynamic module manipulation commands for Atlas orchestration. Enables adding, modifying, removing, prioritizing, and reassigning modules during the Orchestration Phase.
